        ...
        <div class="row text-center">
            ...
            <div class="col-sm-4" style="height: 350px; margin-bottom: 20px;">
                <div class="thumbnail">
                    ...
                    <p class="price">Tk <%=product.getProdPrice()%></p>
                    <form method="post">
                        ...
                        &nbsp;&nbsp;&nbsp;
                        <!-- View Product Button styled like Buy Now button -->
                        <a href="./adminProductDetails.jsp?pid=<%=product.getProdId()%>" class="btn btn-primary" style="text-decoration: none; color: white;">View Product</a>
                    </form>
                </div>
            </div>
            <%
